...
static const struct ili9881c_instr mdt0500cisc_init[] = {
	...
	ILI9881C_COMMAND_INSTR(0x55,0xA5),
	...
	ILI9881C_COMMAND_INSTR(0xB7,0x00),
...
static int ili9881c_bist_mode(struct ili9881c *ctx, bool enable)
{
	dev_dbg(&ctx->dsi->dev, "ili9881c_bist_mode %d\n", enable);

	ili9881c_switch_page(ctx, 4);
	ili9881c_send_cmd_data(ctx, 0x2D, 0xFF);
	ili9881c_send_cmd_data(ctx, 0x2f, 0x00 | (enable ? 0x01 : 0x00));
...
static int ili9881c_prepare(struct drm_panel *panel)
{
	...
	dev_dbg(&ctx->dsi->dev, "ili9881c_prepare\n");

	/* Power the panel */
	ret = regulator_enable(ctx->power);
	if (ret)
	{
		dev_err(&ctx->dsi->dev, "Failed to enable power supply\n");
		return ret;
	}
	msleep(5);
...
{
	void __iomem *iobase = ioremap(0xa0010000, 0xFF);
	struct ili9881c *ctx = panel_to_ili9881c(panel);

	dev_dbg(&ctx->dsi->dev, "ili9881c_enable\n");

	msleep(120);

	mipi_dsi_dcs_set_display_on(ctx->dsi);

	writel(0xFF, iobase + 0x24);
	iounmap(iobase);
...
static int ili9881c_disable(struct drm_panel *panel)
{
	...
	dev_dbg(&ctx->dsi->dev, "ili9881c_disable\n");
...
static int ili9881c_unprepare(struct drm_panel *panel)
{
	...
	dev_dbg(&ctx->dsi->dev, "ili9881c_unprepare\n");
...
static const struct drm_display_mode mdt0500cisc_default_mode = {
	.clock		= 60000,

	.hdisplay	 = 720,
	.hsync_start = 720 + 1294,
	.hsync_end	 = 720 + 1294 + 1294,
	.htotal		 = 720 + 1294 + 1294 + 1294,

	.vdisplay	= 1280,
	.vsync_start	= 1280 + 11,
	.vsync_end	= 1280 + 11 + 11,
	.vtotal		= 1280 + 11 + 11 + 11,
			      ...
			      struct drm_connector *connector)
{
	...
	dev_dbg(&ctx->dsi->dev, "ili9881c_get_modes\n");
...
static enum drm_panel_orientation ili9881c_get_orientation(struct drm_panel *panel)
{
	...
	dev_dbg(&ctx->dsi->dev, "ili9881c_get_orientation\n");
...
static int ili9881c_dsi_probe(struct mipi_dsi_device *dsi)
{
	...
	dev_dbg(&dsi->dev, "ili9881c_dsi_probe\n");
	...
	ret = of_property_read_u32(dsi->dev.of_node, "bist", &bist);
	ctx->enable_bist = (ret!=0) || (bist==0) ? false : true;
...
static void ili9881c_dsi_remove(struct mipi_dsi_device *dsi)
{
	...
	dev_dbg(&dsi->dev, "Removing ILI9881C panel\n");

	mipi_dsi_detach(dsi);
	drm_panel_remove(&ctx->panel);
}

static const struct ili9881c_desc mdt0500cisc_desc = {
	.init = mdt0500cisc_init,
	.init_length = ARRAY_SIZE(mdt0500cisc_init),
	.mode = &mdt0500cisc_default_mode,
...
static const struct of_device_id ili9881c_of_match[] = {
	...
	{ .compatible = "midas,mdt0500cisc", .data = &mdt0500cisc_desc },
	{ }
};
